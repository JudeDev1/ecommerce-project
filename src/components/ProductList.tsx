...
export const products = {
  ...
  KIDS: [
    { id: 1, name: "Zephyr kiddies Wears", price: 45.0, image: kid1 },
    { id: 2, name: "Zephyr kiddies Wears", price: 45.0, image: kid2 },
    { id: 3, name: "Zephyr Kiddies Wears", price: 45.0, image: kid3 },
    { id: 4, name: "Zephyr Kiddies Wears", price: 45.0, image: kid4 },
    { id: 5, name: "Zephyr Kiddies Wears", price: 45.0, image: kid5 },
    { id: 6, name: "Zephyr Kiddies Wears", price: 45.0, image: kid6 },
 
  ]
};

export default function ProductList() {
  const { activeCategory } = useProduct(); // 
